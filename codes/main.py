...
def main(seed, epochs, lr, batch_size, valid_batch_size, valid_interval, valid_thr,
    ...
    save_dir_root = '/opt/ml/input/code/workspace'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--valid_interval', type=int, default=10, help='validation after {valid_interval} epochs (default: 10)')
    parser.add_argument('--valid_thr', type=float, default=.5, help='validation threshold (default: 0.5)')
   
   
    parser.add_argument('--image_root', type=str, default="/opt/ml/input/data/train/DCM", help="train image root (default: /opt/ml/input/data/train/DCM)")
    parser.add_argument('--label_root', type=str, default="/opt/ml/input/data/train/outputs_json", help="train label root (default: /opt/ml/input/data/train/outputs_json)")
